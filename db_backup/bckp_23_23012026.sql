...
\restrict tm4pjicjSjUq5zr4pYC7zczm35bW19qUbvut2iCYMASdACNZxe1ahcgEKVlp3wJ

-- Dumped from database version 18.1
-- Dumped by pg_dump version 18.1

-- Started on 2026-01-23 17:02:45
...
--
-- TOC entry 931 (class 1247 OID 90424)
...
--
-- TOC entry 934 (class 1247 OID 90434)
...
--
-- TOC entry 294 (class 1255 OID 106735)
-- Name: can_access_branch(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.can_access_branch(user_branch_id integer, target_branch_id integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
    is_hq BOOLEAN;
BEGIN
    -- Check if user is in headquarters
    SELECT is_headquarters INTO is_hq FROM branches WHERE id = user_branch_id;
    IF is_hq THEN
        RETURN TRUE;
    END IF;
    
    -- Check if target branch is same or descendant of user's branch
    RETURN target_branch_id IN (SELECT get_descendant_branch_ids(user_branch_id));
END;
$$;


ALTER FUNCTION public.can_access_branch(user_branch_id integer, target_branch_id integer) OWNER TO postgres;

--
-- TOC entry 307 (class 1255 OID 114856)
-- Name: can_access_company(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.can_access_company(p_user_id integer, p_company_id integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    SELECT role_id, company_id INTO user_role_id, user_company_id
    ...
    -- Check if role has any company restrictions
    SELECT EXISTS(
        SELECT 1 FROM role_company_access WHERE role_id = user_role_id
    ) INTO has_restriction;
    
    -- If no restrictions exist for this role, allow all companies
    IF NOT has_restriction THEN
        RETURN TRUE;
    END IF;
    
    -- Check if target company is in the allowed list
    RETURN EXISTS(
        SELECT 1 FROM role_company_access 
        WHERE role_id = user_role_id AND company_id = p_company_id
    );
END;
$$;


ALTER FUNCTION public.can_access_company(p_user_id integer, p_company_id integer) OWNER TO postgres;

--
-- TOC entry 5585 (class 0 OID 0)
-- Dependencies: 307
-- Name: FUNCTION can_access_company(p_user_id integer, p_company_id integer); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION public.can_access_company(p_user_id integer, p_company_id integer) IS 'Check if a user can access data from a specific company based on role restrictions';


--
-- TOC entry 291 (class 1255 OID 106713)
...
--
-- TOC entry 309 (class 1255 OID 114858)
-- Name: check_user_permission_with_company(integer, character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.check_user_permission_with_company(p_user_id integer, p_module_code character varying, p_action character varying) RETURNS TABLE(has_permission boolean, branch_level_access boolean, company_level_access boolean, user_branch_id integer, user_company_id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    SELECT 
        ...
        COALESCE(rp.branch_level_access, FALSE) as branch_level_access,
        COALESCE(rp.company_level_access, FALSE) as company_level_access,
        u.branch_id as user_branch_id,
...
ALTER FUNCTION public.check_user_permission_with_company(p_user_id integer, p_module_code character varying, p_action character varying) OWNER TO postgres;

--
-- TOC entry 289 (class 1255 OID 90443)
...
--
-- TOC entry 308 (class 1255 OID 114857)
-- Name: get_accessible_company_ids(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_accessible_company_ids(p_role_id integer) RETURNS TABLE(company_id integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    has_restriction BOOLEAN;
BEGIN
    -- Check if role has any company restrictions
    SELECT EXISTS(
        SELECT 1 FROM role_company_access WHERE role_id = p_role_id
    ) INTO has_restriction;
    
    -- If no restrictions, return all active companies
    IF NOT has_restriction THEN
        RETURN QUERY SELECT c.id FROM companies c WHERE c.is_active = TRUE;
    ELSE
        -- Return only allowed companies
        RETURN QUERY 
        SELECT rca.company_id 
        FROM role_company_access rca
        INNER JOIN companies c ON rca.company_id = c.id
        WHERE rca.role_id = p_role_id AND c.is_active = TRUE;
    END IF;
END;
$$;


ALTER FUNCTION public.get_accessible_company_ids(p_role_id integer) OWNER TO postgres;

--
-- TOC entry 5586 (class 0 OID 0)
-- Dependencies: 308
-- Name: FUNCTION get_accessible_company_ids(p_role_id integer); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION public.get_accessible_company_ids(p_role_id integer) IS 'Get list of company IDs that a role can access';


--
-- TOC entry 293 (class 1255 OID 106734)
-- Name: get_ancestor_branch_ids(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_ancestor_branch_ids(branch_id integer) RETURNS TABLE(id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    WITH RECURSIVE branch_tree AS (
        ...
        SELECT b.id, b.parent_id
        FROM branches b
        INNER JOIN branch_tree bt ON b.id = bt.parent_id
    )
    SELECT bt.id FROM branch_tree bt;
END;
$$;


ALTER FUNCTION public.get_ancestor_branch_ids(branch_id integer) OWNER TO postgres;

--
-- TOC entry 292 (class 1255 OID 106733)
-- Name: get_descendant_branch_ids(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_descendant_branch_ids(branch_id integer) RETURNS TABLE(id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_descendant_branch_ids(branch_id integer) OWNER TO postgres;

--
-- TOC entry 295 (class 1255 OID 106736)
-- Name: update_hierarchy_level(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_hierarchy_level() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    ELSE
        SELECT hierarchy_level INTO parent_level FROM branches WHERE id = NEW.parent_id;
...
ALTER FUNCTION public.update_hierarchy_level() OWNER TO postgres;

--
-- TOC entry 290 (class 1255 OID 90444)
...
--
-- TOC entry 288 (class 1259 OID 114830)
-- Name: role_company_access; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.role_company_access OWNER TO postgres;

--
-- TOC entry 5665 (class 0 OID 0)
-- Dependencies: 288
-- Name: TABLE role_company_access; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.role_company_access IS 'Defines which companies a role can access. Empty = all companies, entries = restricted to listed companies';


--
-- TOC entry 287 (class 1259 OID 114829)
-- Name: role_company_access_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.role_company_access_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.role_company_access_id_seq OWNER TO postgres;

--
-- TOC entry 5666 (class 0 OID 0)
-- Dependencies: 287
-- Name: role_company_access_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.role_company_access_id_seq OWNED BY public.role_company_access.id;
...
CREATE TABLE public.role_permissions (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    company_level_access boolean DEFAULT false
);
...
-- Dependencies: 284
-- Name: COLUMN role_permissions.company_level_access; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.role_permissions.company_level_access IS 'When TRUE, data is filtered to only show records from companies the user can access';
...
--
-- TOC entry 5001 (class 2604 OID 90814)
...
--
-- TOC entry 5003 (class 2604 OID 90815)
...
--
-- TOC entry 5006 (class 2604 OID 90816)
...
--
-- TOC entry 5010 (class 2604 OID 90817)
...
--
-- TOC entry 5014 (class 2604 OID 90818)
...
--
-- TOC entry 5017 (class 2604 OID 90819)
...
--
-- TOC entry 5018 (class 2604 OID 90820)
...
--
-- TOC entry 5022 (class 2604 OID 90821)
...
--
-- TOC entry 5023 (class 2604 OID 90822)
...
--
-- TOC entry 5028 (class 2604 OID 90823)
...
--
-- TOC entry 5033 (class 2604 OID 90824)
...
--
-- TOC entry 5041 (class 2604 OID 90825)
...
--
-- TOC entry 5045 (class 2604 OID 90826)
...
--
-- TOC entry 5048 (class 2604 OID 90827)
...
--
-- TOC entry 5050 (class 2604 OID 90828)
...
--
-- TOC entry 5053 (class 2604 OID 90829)
...
--
-- TOC entry 5056 (class 2604 OID 90830)
...
--
-- TOC entry 5110 (class 2604 OID 106641)
...
--
-- TOC entry 5115 (class 2604 OID 106666)
...
--
-- TOC entry 5057 (class 2604 OID 90831)
...
--
-- TOC entry 5058 (class 2604 OID 90832)
...
--
-- TOC entry 5062 (class 2604 OID 90833)
...
--
-- TOC entry 5064 (class 2604 OID 90834)
...
--
-- TOC entry 5070 (class 2604 OID 90835)
...
--
-- TOC entry 5077 (class 2604 OID 90836)
...
--
-- TOC entry 5081 (class 2604 OID 90837)
...
--
-- TOC entry 5084 (class 2604 OID 90838)
...
--
-- TOC entry 5087 (class 2604 OID 90839)
...
--
-- TOC entry 5124 (class 2604 OID 114833)
-- Name: role_company_access id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role_company_access ALTER COLUMN id SET DEFAULT nextval('public.role_company_access_id_seq'::regclass);


--
-- TOC entry 5119 (class 2604 OID 106690)
...
--
-- TOC entry 5097 (class 2604 OID 90840)
...
--
-- TOC entry 5107 (class 2604 OID 90841)
...
--
-- TOC entry 5513 (class 0 OID 90445)
-- Dependencies: 219
...
33	\N	UPDATE	User	2	{"new_data": {"email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "company": "Jirani Smart", "role_id": "3", "branch_id": "2", "last_name": "Kiprono", "company_id": "5", "department": "ICT and Data entry", "first_name": "Caleb", "employee_id": "2", "middle_name": "", "department_id": "6", "branch_location": "Mwatate"}, "old_data": {"id": 2, "role": "Branch User", "email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "role_id": 3, "location": "Mwatate, Taita Taveta.", "password": "$2a$10$Ir1f3ihE8dtnYky4.FI95ObsE95FRsLeMwLs.dVKrjdEFuoEnEExy", "branch_id": 2, "is_active": true, "last_name": "Kiprono", "role_name": "Branch User", "company_id": null, "first_name": "Caleb", "branch_name": "Mwatate", "employee_id": 2, "middle_name": "", "company_name": null, "departmnt_id": 6, "department_id": null, "department_name": "ICT and Data entry", "is_bulk_imported": false, "employee_last_name": "Kiprono", "employee_first_name": "Caleb", "is_password_changed": false, "password_changed_at": null, "employee_middle_name": ""}}	2026-01-23 11:53:20.954808+03
41	1	TRANSFER ASSET BRANCH	Asset	1	{"reason": "Asset transferred to match employee branch during assignment", "new_branch_id": 2, "old_branch_id": 1}	2026-01-23 14:50:42.633792+03
42	1	ASSIGN ASSET	Assignment	1	{"asset_id": 1, "employee_id": 2, "branch_transferred": true, "asset_status_updated": "In Use"}	2026-01-23 14:50:42.678286+03
...
23	\N	UPDATE	User	1	{"new_data": {"email": "dev@system.local", "phone": "+254740790088", "company": "Jirani Smart", "role_id": "1", "branch_id": "1", "last_name": "Dev", "company_id": "5", "department": "Finance", "first_name": "Dev", "employee_id": "1", "middle_name": "Dev", "department_id": "8", "branch_location": "HQ"}, "old_data": {"id": 1, "role": "Admin", "email": "dev@system.local", "phone": "+254740790088", "role_id": 1, "location": "Mwatate, Taita Taveta.", "password": "$2a$10$pvN0OKHi7HAfYAoid6F3.e9ag3r57KVmPL/tezhi6zubmPPAlFp.C", "branch_id": 1, "is_active": true, "last_name": "Dev", "role_name": "Admin", "company_id": 5, "first_name": "Dev", "branch_name": "HQ", "employee_id": 1, "middle_name": "Dev", "company_name": "Jirani Smart", "departmnt_id": 6, "department_id": 6, "department_name": "ICT and Data entry", "is_bulk_imported": false, "employee_last_name": "Dev", "employee_first_name": "Dev", "is_password_changed": false, "password_changed_at": null, "employee_middle_name": "Dev"}}	2026-01-22 18:43:27.866998+03
24	\N	UPDATE	User	1	{"new_data": {"email": "dev@system.local", "phone": "+254740790088", "company": "Jirani Smart", "role_id": "1", "branch_id": "1", "last_name": "Dev", "company_id": "5", "department": "ICT and Data entry", "first_name": "Dev", "employee_id": "1", "middle_name": "Dev", "department_id": "6", "branch_location": "HQ"}, "old_data": {"id": 1, "role": "Admin", "email": "dev@system.local", "phone": "+254740790088", "role_id": 1, "location": "Mwatate, Taita Taveta.", "password": "$2a$10$pvN0OKHi7HAfYAoid6F3.e9ag3r57KVmPL/tezhi6zubmPPAlFp.C", "branch_id": 1, "is_active": true, "last_name": "Dev", "role_name": "Admin", "company_id": 5, "first_name": "Dev", "branch_name": "HQ", "employee_id": 1, "middle_name": "Dev", "company_name": "Jirani Smart", "departmnt_id": 8, "department_id": 8, "department_name": "Finance", "is_bulk_imported": false, "employee_last_name": "Dev", "employee_first_name": "Dev", "is_password_changed": false, "password_changed_at": null, "employee_middle_name": "Dev"}}	2026-01-22 18:43:53.837559+03
25	1	DELETE	RolePermission	133	{"role_id": 3, "permission_id": 1}	2026-01-22 18:55:56.802713+03
26	1	LOGIN	User	1	{"email": "dev@system.local"}	2026-01-23 11:06:34.760678+03
27	1	CREATE	Branch	2	{"branch_name": "Mwatate"}	2026-01-23 11:47:27.629108+03
28	1	UPDATE	Branch	0	{"action": "update_hierarchy", "changes_count": 1}	2026-01-23 11:48:23.922541+03
29	1	UPDATE	Branch	1	{"action": "set_headquarters", "branch_name": "HQ"}	2026-01-23 11:48:36.578182+03
30	1	UPDATE	Branch	0	{"action": "update_hierarchy", "changes_count": 1}	2026-01-23 11:48:36.617243+03
31	1	LOGIN	User	1	{"email": "dev@system.local"}	2026-01-23 11:49:02.26153+03
32	\N	CREATE	User	2	{"registered_email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 11:52:41.679681+03
34	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 11:53:51.855397+03
35	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 12:55:13.549613+03
36	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 13:04:37.933619+03
37	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 14:27:17.196907+03
38	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 14:39:15.358468+03
39	1	LOGIN	User	1	{"email": "dev@system.local"}	2026-01-23 14:49:05.75444+03
40	1	CREATE	RolePermission	220	{"role_id": 3, "permission_id": 1, "branch_level_access": false}	2026-01-23 14:49:24.509118+03
43	\N	UPDATE	User	2	{"new_data": {"email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "company": "Jirani Smart", "role_id": "1", "branch_id": "2", "last_name": "Kiprono", "company_id": "5", "department": "ICT and Data entry", "first_name": "Caleb", "employee_id": "2", "middle_name": "", "department_id": "6", "branch_location": "Mwatate"}, "old_data": {"id": 2, "role": "Branch User", "email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "role_id": 3, "location": "Mwatate, Taita Taveta.", "password": "$2a$10$Ir1f3ihE8dtnYky4.FI95ObsE95FRsLeMwLs.dVKrjdEFuoEnEExy", "branch_id": 2, "is_active": true, "last_name": "Kiprono", "role_name": "Branch User", "company_id": 5, "first_name": "Caleb", "branch_name": "Mwatate", "employee_id": 2, "middle_name": "", "company_name": "Jirani Smart", "departmnt_id": 6, "department_id": 6, "department_name": "ICT and Data entry", "is_bulk_imported": false, "employee_last_name": "Kiprono", "employee_first_name": "Caleb", "is_password_changed": false, "password_changed_at": null, "employee_middle_name": ""}}	2026-01-23 14:54:58.280683+03
44	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 14:55:13.735648+03
45	\N	UPDATE	User	2	{"new_data": {"email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "company": "Caretaker", "role_id": "3", "branch_id": "2", "last_name": "Kiprono", "company_id": "3", "department": "ICT and Data entry", "first_name": "Caleb", "employee_id": "2", "middle_name": "", "department_id": "6", "branch_location": "Mwatate"}, "old_data": {"id": 2, "role": "Admin", "email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "role_id": 1, "location": "Mwatate, Taita Taveta.", "password": "$2a$10$Ir1f3ihE8dtnYky4.FI95ObsE95FRsLeMwLs.dVKrjdEFuoEnEExy", "branch_id": 2, "is_active": true, "last_name": "Kiprono", "role_name": "Admin", "company_id": 5, "first_name": "Caleb", "branch_name": "Mwatate", "employee_id": 2, "middle_name": "", "company_name": "Jirani Smart", "departmnt_id": 6, "department_id": 6, "department_name": "ICT and Data entry", "is_bulk_imported": false, "employee_last_name": "Kiprono", "employee_first_name": "Caleb", "is_password_changed": false, "password_changed_at": null, "employee_middle_name": ""}}	2026-01-23 14:56:35.234682+03
46	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 14:56:59.513555+03
47	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 6}	2026-01-23 15:33:30.124294+03
48	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": [5]}	2026-01-23 15:33:30.361394+03
49	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:33:59.161728+03
50	1	CREATE	Asset	2	{"asset_tag": "ICT-LPT-002"}	2026-01-23 15:38:12.53858+03
51	1	ASSIGN ASSET	Assignment	2	{"asset_id": 2, "employee_id": 1, "branch_transferred": false, "asset_status_updated": "In Use"}	2026-01-23 15:39:37.460152+03
52	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:41:52.260533+03
53	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 6}	2026-01-23 15:42:25.344361+03
54	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": []}	2026-01-23 15:42:25.384501+03
55	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:42:40.171859+03
56	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:42:57.357055+03
57	\N	UPDATE	User	2	{"new_data": {"email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "company": "Jirani Smart", "role_id": "3", "branch_id": "2", "last_name": "Kiprono", "company_id": "5", "department": "ICT and Data entry", "first_name": "Caleb", "employee_id": "2", "middle_name": "", "department_id": "6", "branch_location": "Mwatate"}, "old_data": {"id": 2, "role": "Branch User", "email": "ckiprono@freestylecodetechnologies.com", "phone": "0793577021", "role_id": 3, "location": "Mwatate, Taita Taveta.", "password": "$2a$10$Ir1f3ihE8dtnYky4.FI95ObsE95FRsLeMwLs.dVKrjdEFuoEnEExy", "branch_id": 2, "is_active": true, "last_name": "Kiprono", "role_name": "Branch User", "company_id": 3, "first_name": "Caleb", "branch_name": "Mwatate", "employee_id": 2, "middle_name": "", "company_name": "Caretaker", "departmnt_id": 6, "department_id": 6, "department_name": "ICT and Data entry", "is_bulk_imported": false, "employee_last_name": "Kiprono", "employee_first_name": "Caleb", "is_password_changed": false, "password_changed_at": null, "employee_middle_name": ""}}	2026-01-23 15:45:14.683065+03
58	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:45:43.393977+03
59	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:46:24.257415+03
60	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 8}	2026-01-23 15:47:55.711765+03
61	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": []}	2026-01-23 15:47:55.892798+03
62	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 8}	2026-01-23 15:48:11.665304+03
63	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": []}	2026-01-23 15:48:11.692219+03
64	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 15:48:29.333656+03
65	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 8}	2026-01-23 15:49:09.227379+03
66	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": []}	2026-01-23 15:49:09.280846+03
67	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 16:00:23.179072+03
68	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 16:01:44.334563+03
69	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 8}	2026-01-23 16:06:46.610955+03
70	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": []}	2026-01-23 16:06:46.642641+03
71	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 16:06:59.532971+03
72	1	UPDATE	RolePermission	3	{"action": "bulk_assign", "role_name": "Branch User", "permissions_count": 8}	2026-01-23 16:07:14.012182+03
73	1	UPDATE	RoleCompanyAccess	3	{"action": "update_company_access", "role_name": "Branch User", "company_ids": []}	2026-01-23 16:07:14.057788+03
74	2	LOGIN	User	2	{"email": "ckiprono@freestylecodetechnologies.com"}	2026-01-23 16:43:56.561401+03
\.


--
-- TOC entry 5515 (class 0 OID 90456)
-- Dependencies: 221
...
--
-- TOC entry 5517 (class 0 OID 90470)
-- Dependencies: 223
...
--
-- TOC entry 5519 (class 0 OID 90481)
-- Dependencies: 225
...
--
-- TOC entry 5521 (class 0 OID 90491)
-- Dependencies: 227
...
--
-- TOC entry 5523 (class 0 OID 90501)
-- Dependencies: 229
...
1	ICT-LPT-001	Laptop	Dell	latitude	L-345679	In Use	2026-01-20	40000.00	test laptop	1	1	2
2	ICT-LPT-002	Laptop	HP	Pavilion	L-3456710	In Use	2026-01-22	70000.00	test	1	1	1
\.


--
-- TOC entry 5525 (class 0 OID 90512)
-- Dependencies: 231
...
--
-- TOC entry 5527 (class 0 OID 90533)
-- Dependencies: 233
-- Data for Name: assignments; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.assignments (id, asset_id, employee_id, assignment_date, return_date, notes) FROM stdin;
1	1	2	2026-01-23	\N	Assigned today
2	2	1	2026-01-23	\N	test
\.


--
-- TOC entry 5529 (class 0 OID 90543)
-- Dependencies: 235
-- Data for Name: branches; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.branches (id, name, location, created_at, updated_at, parent_id, hierarchy_level, is_headquarters, company_id) FROM stdin;
2	Mwatate	Mwatate, Taita Taveta.	2026-01-23 11:47:27.575311+03	2026-01-23 11:47:27.575311+03	1	1	f	5
1	HQ	Mwatate, Taita Taveta.	2025-09-20 11:29:51.759883+03	2025-09-20 11:29:51.759883+03	\N	0	t	5
\.


--
-- TOC entry 5531 (class 0 OID 90553)
-- Dependencies: 237
...
--
-- TOC entry 5533 (class 0 OID 90567)
-- Dependencies: 239
...
--
-- TOC entry 5535 (class 0 OID 90582)
-- Dependencies: 241
...
--
-- TOC entry 5537 (class 0 OID 90591)
-- Dependencies: 243
...
--
-- TOC entry 5539 (class 0 OID 90599)
-- Dependencies: 245
...
2	Caleb	Mwatate	ICT and Data entry	6		Kiprono	2	Jirani Smart
\.


--
-- TOC entry 5541 (class 0 OID 90610)
-- Dependencies: 247
...
--
-- TOC entry 5543 (class 0 OID 90624)
-- Dependencies: 249
...
--
-- TOC entry 5545 (class 0 OID 90634)
-- Dependencies: 251
...
--
-- TOC entry 5573 (class 0 OID 106638)
-- Dependencies: 280
...
--
-- TOC entry 5575 (class 0 OID 106663)
-- Dependencies: 282
...
--
-- TOC entry 5547 (class 0 OID 90645)
-- Dependencies: 253
-- Data for Name: refresh_tokens; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.refresh_tokens (id, token, user_id, expires_at) FROM stdin;
1	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJkZXZAc3lzdGVtLmxvY2FsIiwicm9sZSI6IkFkbWluIiwicm9sZV9pZCI6MSwiYnJhbmNoX2lkIjoxLCJjb21wYW55X2lkIjo1LCJpYXQiOjE3NjkxNzA3NTgsImV4cCI6MTc2OTc3NTU1OH0.EZXX2Ioi8pWD2ESgQds5SCuGaosoD73txV6dNbpsgDs	1	2026-01-30 15:19:18.44+03
20	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJja2lwcm9ub0BqaXJhbmlzbWFydC5jb20iLCJyb2xlIjoiQnJhbmNoIFVzZXIiLCJyb2xlX2lkIjozLCJicmFuY2hfaWQiOjIsImNvbXBhbnlfaWQiOjUsImlhdCI6MTc2OTE3NTgzNiwiZXhwIjoxNzY5NzgwNjM2fQ.Xj0ok5UqDgI2mhQJHLI4sdcPCF1GK8xm_QekG4HCUsA	2	2026-01-30 16:43:56.553+03
\.


--
-- TOC entry 5549 (class 0 OID 90655)
-- Dependencies: 255
...
--
-- TOC entry 5551 (class 0 OID 90670)
-- Dependencies: 257
...
--
-- TOC entry 5554 (class 0 OID 90682)
-- Dependencies: 260
...
--
-- TOC entry 5556 (class 0 OID 90695)
-- Dependencies: 262
...
--
-- TOC entry 5558 (class 0 OID 90709)
-- Dependencies: 264
...
--
-- TOC entry 5560 (class 0 OID 90720)
-- Dependencies: 266
...
--
-- TOC entry 5562 (class 0 OID 90741)
-- Dependencies: 269
...
--
-- TOC entry 5564 (class 0 OID 90750)
-- Dependencies: 271
...
--
-- TOC entry 5579 (class 0 OID 114830)
-- Dependencies: 288
-- Data for Name: role_company_access; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.role_company_access (id, role_id, company_id, created_at, updated_at) FROM stdin;
\.


--
-- TOC entry 5577 (class 0 OID 106687)
-- Dependencies: 284
-- Data for Name: role_permissions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.role_permissions (id, role_id, permission_id, branch_level_access, created_at, updated_at, company_level_access) FROM stdin;
1	1	1	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
2	1	2	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
3	1	3	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
4	1	4	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
5	1	5	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
6	1	6	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
7	1	7	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
8	1	8	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
9	1	9	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
10	1	10	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
11	1	11	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
12	1	12	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
13	1	13	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
14	1	14	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
15	1	15	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
16	1	16	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
17	1	17	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
18	1	18	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
19	1	19	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
20	1	20	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
21	1	21	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
22	1	22	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
23	1	23	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
24	1	24	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
25	1	25	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
26	1	26	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
27	1	27	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
28	1	28	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
29	1	29	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
30	1	30	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
31	1	31	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
32	1	32	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
33	1	33	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
34	1	34	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
35	1	35	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
36	1	36	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
37	1	37	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
38	1	38	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
39	1	39	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
40	1	40	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
41	1	41	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
42	1	42	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
43	1	43	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
44	1	44	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
45	1	45	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
46	1	46	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
47	1	47	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
48	1	48	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
49	1	49	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
50	1	50	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
51	1	51	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
52	1	52	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
53	1	53	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
54	1	54	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
55	1	55	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
56	1	56	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
57	1	57	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
58	1	58	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
59	1	59	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
60	1	60	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
61	1	61	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
62	1	62	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
63	1	63	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
64	1	64	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
65	1	65	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
66	1	66	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
67	1	67	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
68	1	68	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
69	1	69	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
70	1	70	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
71	1	71	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
72	1	72	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
73	1	73	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
74	1	74	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
75	1	75	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
76	1	76	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
77	1	77	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
78	1	78	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
79	1	79	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
80	1	80	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
81	1	81	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
82	1	82	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
83	1	83	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
84	1	84	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
85	1	85	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
86	1	86	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
87	1	87	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
88	1	88	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
89	1	89	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
90	1	90	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
91	1	91	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
92	1	92	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
93	1	93	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
94	1	94	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
95	1	95	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
96	1	96	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
97	1	97	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
98	1	98	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
99	1	99	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
100	1	100	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
101	1	101	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
102	1	102	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
103	1	103	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
104	1	104	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
105	1	105	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
106	1	106	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
107	1	107	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
108	1	108	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
109	1	109	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
110	1	110	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
111	1	111	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
112	1	112	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
113	1	113	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
114	1	114	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
115	1	115	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
116	1	116	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
117	1	117	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
118	1	118	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
119	1	119	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
120	1	120	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
121	1	121	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
122	1	122	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
123	1	123	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
124	1	124	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
125	1	125	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
126	1	126	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
127	1	127	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
128	1	128	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
129	1	129	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
130	1	130	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
131	1	131	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
132	1	132	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
142	4	1	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
143	4	2	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
144	4	3	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
145	4	4	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
146	4	5	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
147	4	6	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
148	4	7	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
149	4	8	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
150	4	33	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
151	4	34	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
152	4	35	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
153	4	36	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
154	4	37	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
155	4	38	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
156	4	39	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
157	4	40	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
158	4	9	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
159	4	10	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
160	4	11	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
161	4	12	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
162	4	41	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
163	4	42	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
164	4	43	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
165	4	44	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
166	4	45	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
167	4	46	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
168	4	47	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
169	4	48	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
170	4	13	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
171	4	14	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
172	4	15	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
173	4	16	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
174	4	49	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
175	4	50	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
176	4	51	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
177	4	52	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
178	4	21	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
179	4	65	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
180	4	69	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
181	4	73	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
182	4	77	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
183	4	81	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
184	4	17	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
185	4	19	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
186	4	53	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
187	4	55	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
188	4	57	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
189	4	59	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
190	4	61	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
191	4	63	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
192	2	1	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
193	2	6	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
194	2	5	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
195	2	7	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
196	2	34	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
197	2	33	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
198	2	35	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
199	2	38	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
200	2	37	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
201	2	39	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
202	2	9	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
203	2	41	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
204	2	45	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
205	2	14	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
206	2	13	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
207	2	50	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
208	2	49	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
209	2	17	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
210	2	18	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
211	2	53	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
212	2	54	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
213	2	57	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
214	2	58	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
215	2	21	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
216	2	65	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
217	2	69	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
218	2	73	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
219	2	77	f	2026-01-22 11:45:20.242276	2026-01-22 11:45:20.242276	f
265	3	1	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
266	3	37	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
267	3	53	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
268	3	54	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
269	3	57	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
270	3	58	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
271	3	65	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
272	3	69	t	2026-01-23 16:07:13.984826	2026-01-23 16:07:13.984826	f
\.


--
-- TOC entry 5566 (class 0 OID 90769)
-- Dependencies: 273
...
--
-- TOC entry 5568 (class 0 OID 90775)
-- Dependencies: 275
-- Data for Name: session; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.session (sid, sess, expire) FROM stdin;
Fy6gSc6DzKWuDfMTgwyqkEbxplYNeqb-	{"cookie":{"originalMaxAge":86400000,"expires":"2026-01-24T13:26:09.083Z","secure":false,"httpOnly":true,"path":"/"},"returnTo":"/reports/repair-summary?from=reports-menu"}	2026-01-24 16:26:10
KbcdDlAITif5oldpaFWcdFwzW7_TG5DY	{"cookie":{"originalMaxAge":86400000,"expires":"2026-01-24T08:53:51.863Z","secure":false,"httpOnly":true,"path":"/"}}	2026-01-24 16:00:25
\.


--
-- TOC entry 5569 (class 0 OID 90783)
-- Dependencies: 276
...
--
-- TOC entry 5570 (class 0 OID 90800)
-- Dependencies: 277
...
2	2	Caleb		Kiprono	ckiprono@freestylecodetechnologies.com	$2a$10$Ir1f3ihE8dtnYky4.FI95ObsE95FRsLeMwLs.dVKrjdEFuoEnEExy	3	6	0793577021	2	t	f	\N	f	5
\.
...
SELECT pg_catalog.setval('public.action_logs_id_seq', 74, true);
...
-- Dependencies: 287
-- Name: role_company_access_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.role_company_access_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.role_permissions_id_seq', 272, true);
...
--
-- TOC entry 5135 (class 2606 OID 90843)
...
--
-- TOC entry 5137 (class 2606 OID 90845)
...
--
-- TOC entry 5141 (class 2606 OID 90847)
...
--
-- TOC entry 5143 (class 2606 OID 90849)
...
--
-- TOC entry 5146 (class 2606 OID 90851)
...
--
-- TOC entry 5148 (class 2606 OID 90853)
...
--
-- TOC entry 5150 (class 2606 OID 90855)
...
--
-- TOC entry 5152 (class 2606 OID 90857)
...
--
-- TOC entry 5155 (class 2606 OID 90859)
...
--
-- TOC entry 5157 (class 2606 OID 90861)
...
--
-- TOC entry 5159 (class 2606 OID 90863)
...
--
-- TOC entry 5161 (class 2606 OID 90865)
...
--
-- TOC entry 5167 (class 2606 OID 90867)
...
--
-- TOC entry 5172 (class 2606 OID 90869)
...
--
-- TOC entry 5177 (class 2606 OID 90871)
...
--
-- TOC entry 5179 (class 2606 OID 90873)
...
--
-- TOC entry 5184 (class 2606 OID 90875)
...
--
-- TOC entry 5188 (class 2606 OID 90877)
...
--
-- TOC entry 5190 (class 2606 OID 90879)
...
--
-- TOC entry 5194 (class 2606 OID 90881)
...
--
-- TOC entry 5196 (class 2606 OID 90883)
...
--
-- TOC entry 5198 (class 2606 OID 90885)
...
--
-- TOC entry 5200 (class 2606 OID 90887)
...
--
-- TOC entry 5202 (class 2606 OID 90889)
...
--
-- TOC entry 5205 (class 2606 OID 90891)
...
--
-- TOC entry 5209 (class 2606 OID 90893)
...
--
-- TOC entry 5211 (class 2606 OID 90895)
...
--
-- TOC entry 5214 (class 2606 OID 90897)
...
--
-- TOC entry 5284 (class 2606 OID 106654)
...
--
-- TOC entry 5286 (class 2606 OID 106652)
...
--
-- TOC entry 5289 (class 2606 OID 106679)
...
--
-- TOC entry 5291 (class 2606 OID 106677)
...
--
-- TOC entry 5220 (class 2606 OID 90899)
...
--
-- TOC entry 5222 (class 2606 OID 90901)
...
--
-- TOC entry 5224 (class 2606 OID 90903)
...
--
-- TOC entry 5227 (class 2606 OID 90905)
...
--
-- TOC entry 5230 (class 2606 OID 90907)
...
--
-- TOC entry 5232 (class 2606 OID 90909)
...
--
-- TOC entry 5234 (class 2606 OID 90911)
...
--
-- TOC entry 5236 (class 2606 OID 90913)
...
--
-- TOC entry 5238 (class 2606 OID 90915)
...
--
-- TOC entry 5240 (class 2606 OID 90917)
...
--
-- TOC entry 5242 (class 2606 OID 90919)
...
--
-- TOC entry 5250 (class 2606 OID 90921)
...
--
-- TOC entry 5252 (class 2606 OID 90923)
...
--
-- TOC entry 5256 (class 2606 OID 90925)
...
--
-- TOC entry 5258 (class 2606 OID 90927)
...
--
-- TOC entry 5262 (class 2606 OID 90929)
...
--
-- TOC entry 5264 (class 2606 OID 90931)
...
--
-- TOC entry 5301 (class 2606 OID 114840)
-- Name: role_company_access role_company_access_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role_company_access
    ADD CONSTRAINT role_company_access_pkey PRIMARY KEY (id);


--
-- TOC entry 5303 (class 2606 OID 114842)
-- Name: role_company_access role_company_access_role_id_company_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role_company_access
    ADD CONSTRAINT role_company_access_role_id_company_id_key UNIQUE (role_id, company_id);


--
-- TOC entry 5295 (class 2606 OID 106698)
...
--
-- TOC entry 5297 (class 2606 OID 106700)
...
--
-- TOC entry 5266 (class 2606 OID 90933)
...
--
-- TOC entry 5268 (class 2606 OID 90935)
...
--
-- TOC entry 5270 (class 2606 OID 90937)
...
--
-- TOC entry 5272 (class 2606 OID 90939)
...
--
-- TOC entry 5276 (class 2606 OID 90941)
...
--
-- TOC entry 5278 (class 2606 OID 90943)
...
--
-- TOC entry 5280 (class 2606 OID 90945)
...
--
-- TOC entry 5138 (class 1259 OID 90946)
...
--
-- TOC entry 5139 (class 1259 OID 90947)
...
--
-- TOC entry 5144 (class 1259 OID 90948)
...
--
-- TOC entry 5153 (class 1259 OID 90949)
...
--
-- TOC entry 5162 (class 1259 OID 90950)
...
--
-- TOC entry 5163 (class 1259 OID 90951)
...
--
-- TOC entry 5164 (class 1259 OID 90952)
...
--
-- TOC entry 5165 (class 1259 OID 90953)
...
--
-- TOC entry 5168 (class 1259 OID 90954)
...
--
-- TOC entry 5169 (class 1259 OID 90955)
...
--
-- TOC entry 5170 (class 1259 OID 90956)
...
--
-- TOC entry 5173 (class 1259 OID 90957)
...
--
-- TOC entry 5174 (class 1259 OID 90958)
...
--
-- TOC entry 5175 (class 1259 OID 90959)
...
--
-- TOC entry 5180 (class 1259 OID 114864)
...
--
-- TOC entry 5181 (class 1259 OID 106732)
-- Name: idx_branches_hierarchy_level; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_branches_hierarchy_level ON public.branches USING btree (hierarchy_level);


--
-- TOC entry 5182 (class 1259 OID 106731)
-- Name: idx_branches_parent_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 5185 (class 1259 OID 90960)
...
--
-- TOC entry 5186 (class 1259 OID 90961)
...
--
-- TOC entry 5191 (class 1259 OID 90962)
...
--
-- TOC entry 5192 (class 1259 OID 90963)
...
--
-- TOC entry 5203 (class 1259 OID 90964)
...
--
-- TOC entry 5206 (class 1259 OID 90965)
...
--
-- TOC entry 5207 (class 1259 OID 90966)
...
--
-- TOC entry 5212 (class 1259 OID 90967)
...
--
-- TOC entry 5215 (class 1259 OID 90968)
...
--
-- TOC entry 5216 (class 1259 OID 90969)
...
--
-- TOC entry 5217 (class 1259 OID 90970)
...
--
-- TOC entry 5281 (class 1259 OID 106660)
...
--
-- TOC entry 5282 (class 1259 OID 106661)
...
--
-- TOC entry 5287 (class 1259 OID 106685)
...
--
-- TOC entry 5218 (class 1259 OID 90971)
...
--
-- TOC entry 5225 (class 1259 OID 90972)
...
--
-- TOC entry 5228 (class 1259 OID 90973)
...
--
-- TOC entry 5243 (class 1259 OID 90974)
...
--
-- TOC entry 5244 (class 1259 OID 90975)
...
--
-- TOC entry 5245 (class 1259 OID 90976)
...
--
-- TOC entry 5246 (class 1259 OID 90977)
...
--
-- TOC entry 5247 (class 1259 OID 90978)
...
--
-- TOC entry 5248 (class 1259 OID 90979)
...
--
-- TOC entry 5298 (class 1259 OID 114854)
-- Name: idx_role_company_access_company_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_role_company_access_company_id ON public.role_company_access USING btree (company_id);


--
-- TOC entry 5299 (class 1259 OID 114853)
-- Name: idx_role_company_access_role_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_role_company_access_role_id ON public.role_company_access USING btree (role_id);


--
-- TOC entry 5292 (class 1259 OID 106712)
...
--
-- TOC entry 5293 (class 1259 OID 106711)
...
--
-- TOC entry 5273 (class 1259 OID 90980)
...
--
-- TOC entry 5274 (class 1259 OID 90981)
...
--
-- TOC entry 5253 (class 1259 OID 90982)
...
--
-- TOC entry 5254 (class 1259 OID 90983)
...
--
-- TOC entry 5259 (class 1259 OID 90984)
...
--
-- TOC entry 5260 (class 1259 OID 90985)
...
--
-- TOC entry 5361 (class 2620 OID 90986)
...
--
-- TOC entry 5360 (class 2620 OID 106737)
-- Name: branches trigger_update_hierarchy_level; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_update_hierarchy_level BEFORE INSERT OR UPDATE OF parent_id ON public.branches FOR EACH ROW EXECUTE FUNCTION public.update_hierarchy_level();


--
-- TOC entry 5362 (class 2620 OID 90987)
...
--
-- TOC entry 5304 (class 2606 OID 90988)
...
--
-- TOC entry 5308 (class 2606 OID 90993)
...
--
-- TOC entry 5307 (class 2606 OID 90998)
...
--
-- TOC entry 5309 (class 2606 OID 91003)
...
--
-- TOC entry 5311 (class 2606 OID 91008)
...
--
-- TOC entry 5312 (class 2606 OID 91013)
...
--
-- TOC entry 5313 (class 2606 OID 91018)
...
--
-- TOC entry 5314 (class 2606 OID 91023)
...
--
-- TOC entry 5310 (class 2606 OID 91028)
...
--
-- TOC entry 5315 (class 2606 OID 114859)
...
--
-- TOC entry 5316 (class 2606 OID 106724)
...
--
-- TOC entry 5317 (class 2606 OID 91033)
...
--
-- TOC entry 5318 (class 2606 OID 91038)
...
--
-- TOC entry 5319 (class 2606 OID 91043)
...
--
-- TOC entry 5320 (class 2606 OID 91048)
...
--
-- TOC entry 5324 (class 2606 OID 91053)
...
--
-- TOC entry 5325 (class 2606 OID 91058)
...
--
-- TOC entry 5326 (class 2606 OID 91063)
...
--
-- TOC entry 5305 (class 2606 OID 91068)
...
--
-- TOC entry 5306 (class 2606 OID 91073)
...
--
-- TOC entry 5321 (class 2606 OID 91078)
...
--
-- TOC entry 5322 (class 2606 OID 91083)
...
--
-- TOC entry 5323 (class 2606 OID 91088)
...
--
-- TOC entry 5349 (class 2606 OID 91093)
...
--
-- TOC entry 5350 (class 2606 OID 91098)
...
--
-- TOC entry 5351 (class 2606 OID 91103)
...
--
-- TOC entry 5354 (class 2606 OID 106655)
...
--
-- TOC entry 5355 (class 2606 OID 106680)
...
--
-- TOC entry 5327 (class 2606 OID 91108)
...
--
-- TOC entry 5328 (class 2606 OID 91113)
...
--
-- TOC entry 5329 (class 2606 OID 91118)
...
--
-- TOC entry 5330 (class 2606 OID 91123)
...
--
-- TOC entry 5331 (class 2606 OID 91128)
...
--
-- TOC entry 5332 (class 2606 OID 91133)
...
--
-- TOC entry 5333 (class 2606 OID 91138)
...
--
-- TOC entry 5334 (class 2606 OID 91143)
...
--
-- TOC entry 5335 (class 2606 OID 91148)
...
--
-- TOC entry 5336 (class 2606 OID 91153)
...
--
-- TOC entry 5337 (class 2606 OID 91158)
...
--
-- TOC entry 5338 (class 2606 OID 91163)
...
--
-- TOC entry 5339 (class 2606 OID 91168)
...
--
-- TOC entry 5340 (class 2606 OID 91173)
...
--
-- TOC entry 5341 (class 2606 OID 91178)
...
--
-- TOC entry 5342 (class 2606 OID 91183)
...
--
-- TOC entry 5343 (class 2606 OID 91188)
...
--
-- TOC entry 5344 (class 2606 OID 91193)
...
--
-- TOC entry 5345 (class 2606 OID 91198)
...
--
-- TOC entry 5346 (class 2606 OID 91203)
...
--
-- TOC entry 5347 (class 2606 OID 91208)
...
--
-- TOC entry 5348 (class 2606 OID 91213)
...
--
-- TOC entry 5358 (class 2606 OID 114848)
-- Name: role_company_access role_company_access_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role_company_access
    ADD CONSTRAINT role_company_access_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.companies(id) ON DELETE CASCADE;


--
-- TOC entry 5359 (class 2606 OID 114843)
-- Name: role_company_access role_company_access_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role_company_access
    ADD CONSTRAINT role_company_access_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON DELETE CASCADE;


--
-- TOC entry 5356 (class 2606 OID 106706)
...
--
-- TOC entry 5357 (class 2606 OID 106701)
...
--
-- TOC entry 5352 (class 2606 OID 91218)
...
--
-- TOC entry 5353 (class 2606 OID 91223)
...
-- Completed on 2026-01-23 17:02:46

--
-- PostgreSQL database dump complete
--

\unrestrict tm4pjicjSjUq5zr4pYC7zczm35bW19qUbvut2iCYMASdACNZxe1ahcgEKVlp3wJ
