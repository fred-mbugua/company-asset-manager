...
-- Started on 2025-10-10 17:09:03
...
--
-- TOC entry 5014 (class 0 OID 753438)
-- Dependencies: 230
...
--
-- TOC entry 5022 (class 0 OID 769836)
-- Dependencies: 238
...
--
-- TOC entry 5020 (class 0 OID 769822)
-- Dependencies: 236
...
--
-- TOC entry 5002 (class 0 OID 745115)
-- Dependencies: 218
...
5	LPT-RTR-004	Laptop	Huawei	Huawei Lap	L-B-345678	In Stock	Wote Branch	2024-03-10	40000.00	Replacement laptop.
6	LPT-RTR-005	Laptop	Dell	latitude	L-345678	In Stock	Mwatate	2025-10-02	30000.00	Replacement laptop.
1	ICT-LPT-001	Laptop	Dell	XPS 15	D-XPS-123456	In Stock	Head Office	\N	150000.00	\N
3	ICT-RTR-003	Router	Cisco	Meraki MX64	C-MRK-345678	In Stock	Mombasa Branch	2023-03-10	400.00	Spare router. test
...
--
-- TOC entry 5004 (class 0 OID 745133)
-- Dependencies: 220
...
--
-- TOC entry 5018 (class 0 OID 753476)
-- Dependencies: 234
...
--
-- TOC entry 5016 (class 0 OID 753453)
-- Dependencies: 232
...
--
-- TOC entry 5000 (class 0 OID 745086)
-- Dependencies: 216
...
--
-- TOC entry 5024 (class 0 OID 778014)
-- Dependencies: 240
...
--
-- TOC entry 5006 (class 0 OID 745153)
-- Dependencies: 222
...
--
-- TOC entry 5012 (class 0 OID 745308)
-- Dependencies: 228
...
20	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NywiZW1haWwiOiJmbWJ1Z3VhQGppcmFuaXNtYXJ0LmNvbSIsInJvbGUiOiJBZG1pbiIsImlhdCI6MTc2MDEwNTE0MiwiZXhwIjoxNzYwNzA5OTQyfQ.1vIQyM6HTNj6hsTczNnh9AzoZyT0EJ3RIb4Zlee-laY	7	2025-10-17 17:05:42.778+03
\.


--
-- TOC entry 5008 (class 0 OID 745275)
-- Dependencies: 224
...
--
-- TOC entry 5010 (class 0 OID 745284)
-- Dependencies: 226
...
SELECT pg_catalog.setval('public.action_logs_id_seq', 67, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 75, true);
...
--
-- TOC entry 4855 (class 2606 OID 753447)
...
--
-- TOC entry 4847 (class 2606 OID 745139)
...
--
-- TOC entry 4848 (class 2606 OID 745144)
...
--
-- TOC entry 4849 (class 2606 OID 745161)
...
--
-- TOC entry 4850 (class 2606 OID 753488)
...
--
-- TOC entry 4851 (class 2606 OID 753463)
...
--
-- TOC entry 4854 (class 2606 OID 745318)
...
--
-- TOC entry 4852 (class 2606 OID 745296)
...
--
-- TOC entry 4853 (class 2606 OID 745301)
...
-- Completed on 2025-10-10 17:09:03
