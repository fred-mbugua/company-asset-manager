...
export class AssetController {
    ...
    async statusList(req: Request, res: Response) {
        try {
            const assets = await AssetService.statusList();
            successResponse(res, 200, 'Assets statuses retrieved successfully', assets);
        } catch (error: any) {
