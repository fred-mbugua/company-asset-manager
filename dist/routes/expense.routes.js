...
router.get('/expense-types/:id', middlewares_1.authenticate, (0, express_async_handler_1.default)(controllers_2.ExpenseTypeController.getExpenseTypeById));
router.put('/expense-types/:id', middlewares_1.authenticate, (0, middlewares_1.authorize)(['Admin']), (0, express_async_handler_1.default)(controllers_2.ExpenseTypeController.updateExpenseType));
router.delete('/expense-types/:id', middlewares_1.authenticate, (0, middlewares_1.authorize)(['Admin']), (0, express_async_handler_1.default)(controllers_2.ExpenseTypeController.deleteExpenseType));
