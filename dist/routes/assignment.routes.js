...
router.get('/:id', middlewares_1.authenticate, (0, middlewares_1.authorize)(['Admin', 'Standard User']), (0, express_async_handler_1.default)(controllers_1.AssignmentController.getById));
...
router.get('/asset/:assetId/history', middlewares_1.authenticate, (0, express_async_handler_1.default)(controllers_1.AssignmentController.getAssetHistory));
