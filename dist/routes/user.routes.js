...
router.post('/reset-password/:id', middlewares_1.authenticate, (0, express_async_handler_1.default)(controllers_1.UserController.resetPassword));
router.post('/toggle-status/:id', middlewares_1.authenticate, (0, express_async_handler_1.default)(controllers_1.UserController.toggleStatus));
