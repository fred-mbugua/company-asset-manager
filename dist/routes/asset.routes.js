...
router.put('/asset-statuses/:id', middlewares_1.authenticate, (0, middlewares_1.authorize)(['Admin', 'Super Admin']), (0, express_async_handler_1.default)(controllers_1.AssetStatusController.updateAssetStatus));
router.delete('/asset-statuses/:id', middlewares_1.authenticate, (0, middlewares_1.authorize)(['Admin', 'Super Admin']), (0, express_async_handler_1.default)(controllers_1.AssetStatusController.deleteAssetStatus));
